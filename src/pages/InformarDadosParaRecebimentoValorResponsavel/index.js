...
import { obtemTiposChavePix, gravaDadosParaRecebimentoValorResponsavel } from '../../servicos/firestore';
...
export default function InformarDadosParaRecebimentoValorResponsavel() {
    console.log('InformarDadosParaRecebimentoValorResponsavel')
    ...
    async function validarDadosChavePix() {
        ...
        gravarDadosParaRecebimentoValorResponsavel();
    }

    async function gravarDadosParaRecebimentoValorResponsavel() {
        console.log('gravarDadosParaRecebimentoValorResponsavel: ' + route.params?.id)
        var dadosParaRecebimentoValorResponsavel = {
            idRifa: route.params?.id,
            tipoChavePixResponsavel: tipoChavePix,
            chavePixResponsavel: chavePix,
            nomePessoaChavePixResponsavel: nomePessoaChavePix
        }
        setLoading(true)
        const resultado = await gravaDadosParaRecebimentoValorResponsavel(dadosParaRecebimentoValorResponsavel);
        setLoading(false)
        console.log('resultado: ' + resultado)
        if (resultado == 'sucesso') {
            setDadosGravados(true)
            console.log('Dados para recebimento do valor pelo responsável gravados com sucesso ')
            setMensagemCadastro('Dados para recebimento do valor pelo responsável, gravados com sucesso.');
            return;
        }
        else {
            setDadosGravados(false)
            setMensagemCadastro('Falha gravação dados para recebimento do valor pelo responsável. Tente novamente.');
            return;
        }
    }
                ...
                <ScrollView>
                    <View style={styles.card}>
                        ...
                        <AreaRifa>
                            ...
                            <RifaText> Situação rifa: {route.params?.situacao}</RifaText>
                        </AreaRifa>
                    </View>
                    <View style={styles.corpo}>
                        ...
                        <Texto>
                            Para você receber o valor de R$ {route.params?.vlrLiquidoAReceberResponsavel}, preencha os dados abaixo:
                        </Texto>
                        <Texto> </Texto>
                        <Texto>
